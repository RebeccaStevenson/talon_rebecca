...
sync read start: user.vscode("rebeccaSentenceReader.start")
sync read stop: user.vscode("rebeccaSentenceReader.stop")
sync read capture: user.vscode("rebeccaSentenceReader.captureCurrentSentenceToNotes")

read start: user.vscode("rebeccaSentenceReader.start")
read stop: user.vscode("rebeccaSentenceReader.stop")
read capture: user.vscode("rebeccaSentenceReader.captureCurrentSentenceToNotes")
(stop read | stop reading | stop reading aloud): user.vscode("rebeccaSentenceReader.stop")
