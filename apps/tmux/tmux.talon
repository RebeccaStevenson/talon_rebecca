...
# --- Resize panes ---
resize pane left:
    user.tmux_execute_command("resize-pane -L")

resize pane right:
    user.tmux_execute_command("resize-pane -R")

resize pane up:
    user.tmux_execute_command("resize-pane -U")

resize pane down:
    user.tmux_execute_command("resize-pane -D")
